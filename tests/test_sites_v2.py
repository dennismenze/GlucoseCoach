...
class PersonalSitesContractTests(unittest.TestCase):
    ...
    def test_e2e_contract_is_present(self) -> None:
        ...
        self.assertIn("#meal-method-explanation p.muted", peak_text)
        self.assertIn("stabil bestätigten Rückgang", peak_text)
        self.assertIn("#food-comparison-note", peak_text)
        self.assertIn("not.toBeVisible()", peak_text)
        ...
        self.assertIn("Stabil bestätigter Rückgang", peak_text)
        self.assertNotIn("CGM-Wendepunkt-Proxy", peak_text)
